                ...
                <div class="col-sm">
                    ...
                    <div class="table-responsive">
                        <div>
                            ...
                            <p>${user.street}, ${user.district},  ${user.postalCode}, ${user.floor} ΟΡΟΦΟΣ,  ΟΝΟΜΑ ΣΤΟ ΚΟΥΔΟΥΝΙ-${user.doorbellName}</p>
                            <p>Σταθερό Τηλέφωνο -${user.landlinePhone}, Κινητό Τηλέφωνο-${user.mobilePhone}</p>
                            <button class="btn btn-warning btn-sm"   onclick="location.href = '${pageContext.request.contextPath}/address.htm'">MODIFY ADDRESS</button>
                        </div>
